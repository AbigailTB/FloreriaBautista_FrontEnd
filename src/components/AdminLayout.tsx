    ...
    <div className="flex h-screen overflow-hidden bg-slate-100">
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1 custom-scrollbar">
          ...
          <Link
            to="/admin/inventario"
            className={navLinkClass("/admin/inventario")}
          >
          ...
          <Link
            to="/admin/reportes"
            className={navLinkClass("/admin/reportes")}
          >
          ...
          <div>
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 transition-transform duration-200 ${isTechOpsOpen ? "rotate-180" : ""}`}
              />
            </button>
            ...
            <AnimatePresence>
              {isTechOpsOpen && (
                ...
                >
                  <Link
                    to="/admin/respaldos"
                    className={subNavLinkClass("/admin/respaldos")}
                  >
                  ...
                  <Link
                    to="/admin/monitoreo"
                    className={subNavLinkClass("/admin/monitoreo")}
                  >
                  ...
                  <Link
                    to="/admin/datos"
                    className={subNavLinkClass("/admin/datos")}
                  >
                  ...
                  <Link
                    to="/admin/auditoria"
                    className={subNavLinkClass("/admin/auditoria")}
                  >
          ...
          <Link
            ...
            className={navLinkClass("/admin/configuracion")}
          >
