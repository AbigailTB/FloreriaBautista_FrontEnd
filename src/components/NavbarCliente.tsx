...
import { Search, ShoppingCart, Menu, X, Bell, Settings, LogOut, User } from "lucide-react";
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 bg-[#FBBF24] text-[#1A3B5B] text-[9px] font-bold px-1 rounded-full min-w-[16px] h-[16px] flex items-center justify-center">
                    {cartCount}
                  </span>
                )}
              </button>
            ...
            <div className="relative hidden md:flex items-center gap-3 border-l border-white/20 pl-6">
              ...
              >
                ...
                <img
                  ...
                  alt="User Profile"
                  className="w-8 h-8 rounded-full border-2 border-[#FBBF24]"
                />
              </button>
